...
#define LED_JAUNE_Pin LL_GPIO_PIN_13
#define LED_JAUNE_GPIO_Port GPIOB
#define LED_BLEU_Pin LL_GPIO_PIN_14
#define LED_BLEU_GPIO_Port GPIOB
#define TMS_Pin LL_GPIO_PIN_13
#define TMS_GPIO_Port GPIOA
#define TCK_Pin LL_GPIO_PIN_14
#define TCK_GPIO_Port GPIOA
#define LED_ROUGE_Pin LL_GPIO_PIN_4
#define LED_ROUGE_GPIO_Port GPIOB
#define LED_VERT_Pin LL_GPIO_PIN_5
